...
(function() { // encapsulate all variables so they don't become global vars
	...
	*/
    ...
    textAngular.directive("textAngular", [
        ...
        function($compile, $timeout, taOptions, taSanitize, taSelection, taExecCommand, textAngularManager, $window, $document, $animate, $log) {
            return {
                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    if (scope.taDisabled) {
                        disableTextAngular(scope.taDisabled);
                    }
        ...
        function(taSelection, taBrowserTag, $document) {
        ...
        function taSanitizeFactory($sanitize) {
            ...
            return {
                ...
                link: function(scope, element, attrs, textAngularCtrl) {
                    ...
                    scope._parent = {
                        ...
                        taScope: textAngularCtrl.getTaScope()
                    };
        ...
        function(taToolExecuteAction, taTools, taRegisterTool) {
        ...
        function($window, $document, textAngular) {
            ...
            var clearAllHighlightsFromNode = function(node) {
                var innerHTML = node.innerHTML.replace(/<\/?mark[^>]*>/g, '');
                ...
                var intermediateNodes = getOnlySelectedElements(),
                    ...
                    cleanTags = function(node, tagName) {
                        ...
                        if (node) {
                            ...
                            nodeHTML = node.innerHTML.replace(/<\/?mark[^>]*>/g, '');
                            if (node.nodeName.toLowerCase() === tagName) {
            ...
            var isSelectionUnderTag = function(tagName, editorTopNode) {
                var range = getRange(),
                    ...
                    areintermediateNodesUnderTag = function() {
                        var nodes = (range) ? getOnlySelectedElements() : null,
                            i = 1;
                        if (nodes.length < 3) {
                            return true;
                        } else {
